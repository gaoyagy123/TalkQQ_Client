...
//	void SetBkColor(COLORREF clr);
	BOOL SetBkTransparent( CDC * pDC );
	void ResetBkTransparent(){if(m_hBackgroundBrush)DeleteObject(m_hBackgroundBrush);m_hBackgroundBrush=NULL;};
...
protected:
	...
	RECT m_PaintRect;
	SIZE m_PictureSize;
	//COLORREF m_clrBackground;//ZhangHuaiLiang modify code 2012-06-06
	HBRUSH m_hBackgroundBrush;//ZhangHuaiLiang add code 2012-06-06
	UINT m_nCurrFrame;
	UINT m_nDataSize;
	UINT m_nCurrOffset;
